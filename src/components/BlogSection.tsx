...
const catColors: Record<string, string> = {
  'Tips': '#0066FF', 'Consejos': '#0066FF',
  'Safety': '#EF4444', 'Seguridad': '#EF4444',
  'Technique': '#10B981', 'Técnica': '#10B981',
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <span className="block text-[#0066FF] text-xs font-black tracking-[0.4em] uppercase mb-4">
            {lang === 'en' ? '— KNOWLEDGE BASE' : '— RECURSOS'}
          </span>
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
            ...
            >
              {lang === 'en' ? <>Ski Smarter.<br /><span className="text-gradient-blue">Go Harder.</span></> : <>Esquiá Más<br /><span className="text-gradient-blue">Inteligente.</span></>}
            </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          <AnimatePresence mode="popLayout">
            {displayed.map((post, i) => {
              ...
              const catColor = catColors[postCat] || '#0066FF';
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-gray-900 font-bold text-base mb-2 leading-snug group-hover:text-[#0066FF] transition-colors">
                    ...
                    <button
                      ...
                      className="text-sm font-bold text-[#0066FF] hover:text-[#0055DD] flex items-center gap-1.5 transition-all hover:gap-2.5"
        ...
        {!showAll && filtered.length > 6 && (
          <div className="text-center mt-10">
            <button
              ...
              className="px-8 py-3.5 rounded-xl font-black text-sm border border-gray-300 text-gray-500 hover:border-[#0066FF]/50 hover:text-[#0066FF] transition-all hover:scale-105 uppercase tracking-wide"
            >
