    ...
    >
      <div className="max-w-4xl mx-auto relative z-10">
        <motion.div
          ...
          className="mb-16"
        >
          <span className="block text-[#0066FF] text-xs font-black tracking-[0.4em] uppercase mb-4">FAQ</span>
          <h2
            className="text-gray-900 font-black leading-none"
            style={{ fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', letterSpacing: '-0.03em' }}
          >
            {lang === 'en' ? <>Got<br /><span className="text-gradient-blue">Questions?</span></> : <>¿Tenés<br /><span className="text-gradient-blue">Preguntas?</span></>}
          </h2>
        </motion.div>
            ...
            return (
              <motion.div
                ...
                className={`rounded-2xl border overflow-hidden transition-all duration-300 shadow-sm ${
                  isOpen
                    ? 'border-[#0066FF]/40 bg-white shadow-md'
                    : 'border-gray-200 bg-white hover:border-[#0066FF]/30 hover:shadow-md'
                }`}
              >
                <button
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center font-black text-lg transition-colors ${
                      isOpen ? 'bg-[#0066FF] text-white' : 'bg-gray-100 text-gray-400'
                    }`}
                    aria-hidden="true"
                  >
                    +
